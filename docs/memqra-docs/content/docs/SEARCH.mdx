---
title: "Hybrid search"
description: "The structured + keyword + semantic + relationship search pipeline, and how ranking works."
---
...
authoritative content (see [docs/ARCHITECTURE](/docs/ARCHITECTURE)).
...
pattern, and [docs/ADAPTERS](/docs/ADAPTERS).
